...
set -o errtrace # trace ERR through - enabled
set -o errexit  ## set -e : exit the script if any statement returns a non-true return value - enabled
### lib/functions/image/rootfs-to-fastboot.sh
# shellcheck source=lib/functions/image/rootfs-to-fastboot.sh
source "${SRC}"/lib/functions/image/rootfs-to-fastboot.sh
